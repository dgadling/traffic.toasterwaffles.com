...
$command = "/usr/bin/rrdtool graph $outFile "
         ...
         . " 'GPRINT:out:LAST:Last In\: %5.2lf %sBps'"
         . " 'GPRINT:out:MAX:Max In\: %5.2lf %sBps'"
         . " 'GPRINT:out:AVERAGE:Avg In\: %5.2lf%sBps\\n'"
         . " 'AREA:out#{$colors['in']}:in'"
         . " 'GPRINT:in:LAST:Last Out\: %5.2lf %sBps'"
         . " 'GPRINT:in:MAX:Max Out\: %5.2lf %sBps'"
         . " 'GPRINT:in:AVERAGE:Avg Out\: %5.2lf%sBps\\l'"
         ;
